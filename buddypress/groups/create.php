            ...
            <span class="radiobox-mark"><span></span></span>
				...
				<?php if ( bp_is_active( 'forums' ) ) : ?>
					...
					<?php if ( bp_forums_is_installed_correctly() ) : ?>
						...
						<div class="checkbox">
							<label class="mark-item"><input type="checkbox" name="group-show-forum" id="group-show-forum" value="1"<?php checked( bp_get_new_group_enable_forum(), true, true ); ?> class="checkbox-cb" /> <?php _e( 'Enable discussion forum', 'buddypress' ); ?><span class="checkbox-mark"></span></label>
						</div>
