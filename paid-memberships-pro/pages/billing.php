	...
	<?php } else { ?>
		...
		<form class="pmpro_form" action="<?php echo pmpro_url("billing", "", "https")?>" method="post">
			...
			<div>
				...
				<input type="submit" class="btn btn-default pmpro_btn pmpro_btn-submit" value="<?php _e('Update', 'pmpro');?>" />
				<input type="button" name="cancel" class="btn btn-see-through pmpro_btn pmpro_btn-cancel" value="<?php _e('Cancel', 'pmpro');?>" onclick="location.href='<?php echo pmpro_url("account")?>';" />
			</div>	
