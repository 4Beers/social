...
$output .= '<div class="panel-heading">';
    ...
    $output .= "\n\t\t\t\t" . '<a href="#acc-'.$kleo_acc_id.'-'.$elem_id.'-d" data-parent="#accordion-'.$kleo_acc_id.'" data-toggle="collapse" class="accordion-toggle">'.$title
...
$output .= '<div id="acc-'.$kleo_acc_id.'-'.$elem_id.'-d" class="panel-collapse collapse'.$extra_content_class.'">';
